...
Use [GitHub Security Advisories](https://github.com/Shelpuk-AI-Technology-Consulting/pally-mcp-server/security/advisories/new) to report vulnerabilities privately.
