...
.NOTES
    ...
    References         : https://github.com/Shelpuk-AI-Technology-Consulting/pally-mcp-server
...
For more information, visit: https://github.com/Shelpuk-AI-Technology-Consulting/pally-mcp-server
...
function Show-Version {
    ...
    Write-Host "Project: Shelpuk-AI-Technology-Consulting/pally-mcp-server" -ForegroundColor Gray
}
