...
async def test_chat_codegen_saves_file(monkeypatch, tmp_path):
    """Ensure Gemini 2.5 Pro responses create pally_generated.code when code is emitted."""
    ...
    with monkeypatch.context() as m:
        ...
        working_dir.mkdir()
        preexisting = working_dir / "pally_generated.code"
    ...
    artifact_path = working_dir / "pally_generated.code"
